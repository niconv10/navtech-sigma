...
export function UpcomingList({ assignments, maxItems = 8 }: UpcomingListProps) {
        ...
        {upcomingAssignments.length > 0 ? (
          upcomingAssignments.map((assignment) => {
            ...
            return (
              <div
                key={assignment.id}
                className="list-item flex items-center gap-4 hover:bg-secondary/50 transition-colors -mx-2 px-2 rounded-lg"
              >
                {/* Icon */}
                <div className={cn(
